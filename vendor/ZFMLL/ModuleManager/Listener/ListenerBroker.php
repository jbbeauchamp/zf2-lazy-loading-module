...
use Zend\Loader\PluginBroker,
    ZFMLL\ModuleManager\Listener\Exception\InvalidListenerException;
...
class ListenerBroker extends PluginBroker
{
     ...
     */
    protected $defaultClassLoader = 'ZFMLL\ModuleManager\Listener\ListenerLoader';
    ...
    protected function validatePlugin($plugin)
    {
    	if (!$plugin instanceof AuthorizeHandler) {
            throw new InvalidListenerException('Auth listeners must implement ZFMLL\ModuleManager\Listener\AuthorizeHandler');
        }
    	return true;
    }
